    ...
    public partial class InitialMigration : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    TradeSecurityId = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    PortfolioId = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    TradeSecurityFeeId = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    TradeSecurityId = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    TradeSecurityFundamentalsId = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    TradeSecurityId = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    TradeSecurityPerformanceId = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    TradeSecurityId = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    StampDutyId = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    TradeSecurityFeeId = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    TradeSecurityTransactionId = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    TradeSecurityFeeId = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[] { new Guid("939c458e-5e58-4a08-8579-0d9362ebed0f"), null, new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), "portfolioMastan is a mastan's portfolio.", true, null, null, "portfolioMastan" });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[] { new Guid("edcb61fc-b446-48b5-9f43-45a9bc7a4755"), null, new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), "Wipro Limited is an Indian multinational corporation that provides information technology, consulting and business process services.", null, null, "Wipro", new Guid("939c458e-5e58-4a08-8579-0d9362ebed0f"), "Wipro" });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[] { new Guid("07b764b1-aa58-4375-93cd-e30ce54ace3b"), 120.38m, 0.27m, 1.42m, 22.29m, 2m, 230618m, 3.51m, 18.93m, 28.31m, 20.18m, new Guid("edcb61fc-b446-48b5-9f43-45a9bc7a4755") });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[] { new Guid("79bfacfa-59e2-48e1-a494-ed445804221e"), new DateTime(2022, 7, 5, 10, 11, 48, 598, DateTimeKind.Local).AddTicks(2572), 420.05m, 422.00m, new Guid("edcb61fc-b446-48b5-9f43-45a9bc7a4755"), 1340000000m, 3186358m, 739.85m, 421.75m });
