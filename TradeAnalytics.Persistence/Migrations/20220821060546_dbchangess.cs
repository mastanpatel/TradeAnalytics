...
{
    public partial class dbchangess : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                columns: new[] { "TradeSecurityFundamentalsId", "BookValue", "DebtToEquity", "DividendYield", "EarningPerShare", "FaceValue", "IsCurrent", "MarketCap", "PriceToBook", "PriceToEarning", "PriceToEarning_Industry", "ReturnOnEquityPerc", "TradeSecurityId" },
                values: new object[] { 1, 120.38m, 0.27m, 1.42m, 22.29m, 2m, false, 230618m, 3.51m, 18.93m, 28.31m, 20.18m, 1 });

            migrationBuilder.InsertData(
                table: "TradeSecurityPerformance",
                columns: new[] { "TradeSecurityPerformanceId", "Date", "IsCurrent", "OpenPrice", "PrevClosed", "TradeSecurityId", "Value", "Volume", "Week_52_High", "Week_52_Low" },
                values: new object[] { 1, new DateTime(2022, 8, 21, 11, 35, 44, 672, DateTimeKind.Local).AddTicks(8506), false, 420.05m, 422.00m, 1, 1340000000m, 3186358m, 739.85m, 421.75m });
